...
class Entry(object):
    ...
    def __eq__(self, other):
        ...
        if self.m_priority is not None and other.m_priority is not None:
            return self.m_priority == other.m_priority and self.m_elem == other.m_elem
        else:
            return False
        # if self.m_priority == other.m_priority:
        #     return True
...
class Fibonacci_heap(object):
    ...
    def dequeue_min(self):
        ...
        min_elem = self.m_min
        #print 'element', min_elem.m_elem, min_elem.m_priority
        ...
        # reassign the min.
        #
        # DRS: Added this pair of id's Sep 5, 2014
        if id(self.m_min.m_next) == id(self.m_min):
            # Case one
            self.m_min = None
        else:
            # Case two
        ...
        if min_elem.m_child is not None:
            ...
            while True:
                ...
                # started at.
                curr = curr.m_next
                if id(curr) == id(min_elem.m_child):
        ...
        curr = self.m_min
        while not to_visit or id(to_visit[0]) != id(curr):
    ...
    def query(self, entry):
        return entry.m_priority

    def decrease_key(self, entry, decrement):
        '''
